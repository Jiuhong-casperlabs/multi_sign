...
build-contract:
	...
	cargo build --release -p remove-associated-key --target wasm32-unknown-unknown
	...
	wasm-strip target/wasm32-unknown-unknown/release/remove_associated_key.wasm 2>/dev/null | true
